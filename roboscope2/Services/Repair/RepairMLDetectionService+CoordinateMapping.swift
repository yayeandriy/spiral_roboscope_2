...
//
//  Copied VERBATIM (in logic) from Services/Detection/LaserMLDetectionService+CoordinateMapping.swift
//  (READ-ONLY reference) per 05-ios-repair.md §5.2. Normalized coordinate transforms between
//  oriented-image space and raw pixel-buffer space, covering all 8 CGImagePropertyOrientation
//  cases — called from +Decode.swift.
//
